...
<div class="constitution">
    <h1 class="noUnderscore">BARELY LEAGUE-AL CONSTITUTION</h1>
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(one)}>Section 1: Roster</h3>
        <h4 class="noUnderscore clickable" on:click={() => goToSection(oneOne)}>1.1 Positional Breakdown</h4>
            <h5 class="noUnderscore clickable" on:click={() => goToSection(oneOneOne)}>1.1.1 Bench + IR</h5>
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(five)}>Section 5: League Voting</h3>
    
        <h4 class="noUnderscore clickable" on:click={() => goToSection(fiveOne)}>5.1 League Voting Policy</h4>
    ...
    <p>7 Bench</p>
        ...
        <h4 bind:this={oneOneOne}>1.1.1 Bench + IR</h4>
        
        <div class="subBlock">
            <table class="positionMaximums">
                <tr><td>Bench</td><td class="right">7</td></tr>
                <tr><td>IR</td><td class="right">1</td></tr>
            </table>
        </div>
    ...
    <p>Trading of players and draft picks (up to 3 drafts away) are allowed. Trades will process immediately and will be reversed if vetoed or under investigation for collusion.</p>
    
    <p>Rules for trading draft picks are as follows:<p>
    
        <li>You can trade away 3 picks during the season</li>
        <li>If you trade away a pick, you must receive a pick back</li>
        <li>You cannot trade a 1st round pick</li>
        <li>You can only trade the following years picks</li>
        <li>No pick trading during the draft</li>
        <li>No trading before the 2023 draft</li>
    ...
    <div class="subBlock">
        ...
        <ul>
            <li>First Offense – Teams will not be allowed to play any players for the next 2 weeks</li>
    ...
    <div class="subBlock">
        <p>Trades are not subject to veto but the commissioner reserves the right to step in and at the very least assess the thinking of any team involved in a heavily lop-sided trade </p>
    </div>
        
    <h3 bind:this={oneThree}>1.3 Waiver Wire</h3>
    
    <p>The waiver wire will be managed via a Rolling Waivers system.</p>
         
    <h2 class="sectionHeading" bind:this={two}>Section 2 Drafting</h2>
    
    <h3 bind:this={twoOne}>2.1 Draft Order</h3>
    <p>The draft order each year will be a snake draft. The draft order will be determined through a 'fun' game during the off-season. The only caveat to this is that the wiiner of the toilet bowl in the prvious season gets to choose where they will be drafting.</p>
    ...
    <p>The 4 teams that do not make the playoffs will enter the Toilet Bowl where 7th will play 10th and 8th will play 9th. The winner of those games will face each other in the toilet bowl final. The winner of the final is granted their choice of draft spot in the following season.<p>
    ...
    <h2 class="sectionHeading" bind:this={five}>Section 5 League Voting</h2>
    
    <h3 bind:this={fiveOne}>5.1 League Voting Policy</h3>
    <p> Eac h off-seaoson, owners may submit proposals to change league rules or format. Owners will be offered the opportunity to vote on these proposals. A maximum of 3 proposals will be brought forward to be voted on. It is to the commissioners discretion which proposals are voted on. Voting is not mandatory. Proposals will pass when 60% of owners vote in favour. 
